...
<body>
  ...
  <table>
    ...
    while ($rows = mysqli_fetch_assoc($query)) {
        ...
        echo "<td><a href='delete_supplier.php?id=$id' title='Delete'>
                <img src='delete.jpg' alt='delete' width='25' height='25'>
              </a></td>";
        echo "<td><a href='form_supplier_update.php?id=$id' title='Update'>
  ...
  <br />
  <a class="f" target="_self" href="form_supplier_add.php">Add a new supplier</a>
</body>
</html>
