...
<body>
  ...
  <table>
    ...
    while ($rows = mysqli_fetch_assoc($query)) {
        ...
        echo "<td><a href='delete_category.php?id=" . urlencode($id) . "' title='Delete'>
                <img src='delete.jpg' alt='delete' width='25' height='25'>
              </a></td>";
        echo "<td><a href='form_category_update.php?id=" . urlencode($id) . "' title='Update'>
  ...
  <br />
  <a class="cat" target="_self" href="form_category_add.php">Add a new category</a>
</body>
</html>
